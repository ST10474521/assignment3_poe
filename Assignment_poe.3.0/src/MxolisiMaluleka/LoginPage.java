   ...
   static String password;
    ...
    private void regloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regloginActionPerformed
       Login login = new Login();     
                    DashBaod board = new DashBaod();
        Registration regform = new Registration();
        String username = regusername.getText();
        String password = new String(regpassword.getPassword());   
     
        boolean isSuccess = login.Logintheuser(username, password);

      if (isSuccess) {
                    String statusMessage = login.LoginStatusreturner(true);
                    ...
                    String statusMessage = login.LoginStatusreturner(false);   
